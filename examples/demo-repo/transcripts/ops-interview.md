---
id: ops-interview
title: Ops team interview (raw transcript)
domain: reference
status: reference
authority: unverified
last_verified: 2026-06-10
recheck: 365d
read_when: [why decisions were made, ops history, tribal knowledge]
owner: demo
tags: [transcript, interview]
has_disputed_claims: true
---
# Ops team interview (raw transcript)

> Intake note: transcribed from a call with the (fictional) ops lead. Speaker has no
...
"The Old Mill Yard site was a squeeze; we couldn't fit the full rack in there."
